...
# ==========================================
print("🚀 Booting up ScriptED Backend with Groq (Simple Mode)...")
...
def stage2_analyzer(parsed_json: dict) -> dict:
    """Adds basic analysis tags."""
    print("Stage 2: Adding Basic Analysis...")
...
async def upload_script(file: UploadFile = File(...), session_id: str = Form(...)):
    ...
    try:
        ...
        final_data = stage2_analyzer(parsed_json)
